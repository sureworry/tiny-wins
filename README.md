...
Minimal daily wins journal — log what you conquered, see it accumulate over time.
...
Open [http://localhost:5173/preview.html](http://localhost:5173/preview.html) for the phone-frame preview.
